...
def train_and_evaluate_logistic_regression(x_train, x_test, y_train, y_test, seed):
    ...
    save_path = os.path.join(project_root, 'results', 'Logistic Regression', 'confusion_matrix.png')
    ...
    shap_path = os.path.join(project_root, 'results', 'Logistic Regression', 'shap.png')
    ...
    model_selected = LogisticRegression(max_iter=10000, random_state=seed)
