...
def train_and_evaluate_decision_tree(x_train, x_test, y_train, y_test, seed):
    ...
    save_path = os.path.join(project_root, 'results', 'Decision Tree', 'confusion_matrix.png')
    ...
    shap_path = os.path.join(project_root, 'results', 'Decision Tree', 'shap.png')
    ...
    model_selected = DecisionTreeClassifier(random_state=seed)
